...
Mike owns this. Start: say hi + 1 motivating line.
Work style: telegraph; noun-phrases ok; drop grammar; min tokens.

## Agent Protocol
- Contact: Mike Easley (mike.easley@gmail.com).
- Workspace: `~/Repos`.
...
- Model note (2025-11-23): no `gpt-5.1-pro` / `grok-4.1` on Mikes’s keys yet.

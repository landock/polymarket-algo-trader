...
module.exports = (env, argv) => {
  ...
  return {
    entry: {
      ...
      'popup/limit-orders-page': './src/popup/limit-orders-page.tsx',
      'popup/risk-settings-page': './src/popup/risk-settings-page.tsx',
    },
    output: {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        template: './src/popup/limit-orders.html',
        filename: 'popup/limit-orders.html',
        chunks: ['popup/limit-orders-page'],
      }),
      new HtmlWebpackPlugin({
        template: './src/popup/risk-settings.html',
        filename: 'popup/risk-settings.html',
        chunks: ['popup/risk-settings-page'],
      }),
